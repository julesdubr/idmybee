...
Quelques commentaires : 
    ...
    J'ai systématiquement utilisé cuda quand cela était possible, mais je pense que l'inférence du UNet doit pouvoir se faire sans dans un temps raisonnable. Pour l'entrainement de modèle, et l'utilisation de SAM en local, éa peut-étre plus compliqué.
    Tout ce qui concerne les modèles et l'entraénement est codé avec PyTorch.
